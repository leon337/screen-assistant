...
export function loadConfig(env = process.env) {
  return Object.freeze({
    ...
    maxVoiceCommandBytes: integer(env.MAX_VOICE_COMMAND_BYTES, 2 * 1024 * 1024, { min: 16 * 1024, max: 10 * 1024 * 1024 }),
    voiceCommandTimeoutMs: integer(env.VOICE_COMMAND_TIMEOUT_MS, 12000, { min: 2000, max: 60000 }),
    voiceCommandRateLimitMax: integer(env.VOICE_COMMAND_RATE_LIMIT_MAX, 20, { min: 1, max: 1000 }),
    voiceCommandRateLimitWindowMs: integer(env.VOICE_COMMAND_RATE_LIMIT_WINDOW_MS, 60000, { min: 1000, max: 86400000 }),
