const CACHE = 'screen-assistant-v18';
const APP_SHELL = [
  '/', '/index.html', '/styles.css', '/status.css', '/mobile-v18.css', '/app.js', '/design.js', '/status.js', '/mobile-v18.js', '/analysis.js', '/response.js', '/pwa.js',
