...
const BASELINE_POLICY = `Não invente conteúdo. Quando algo estiver ilegível, escreva exatamente "não foi possível confirmar". Toda resposta deve manter as seções ## Resumo, ## Observação direta e ## Interpretação, além das seções especializadas do perfil.`;
